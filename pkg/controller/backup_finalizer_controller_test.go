...
func TestBackupFinalizerReconcile(t *testing.T) {
	...
	for _, test := range tests {
		t.Run(test.name, func(t *testing.T) {
			...
			backupStore.On("PutBackupContentsFinalUpdates", mock.Anything, mock.Anything).Return(nil)
			...
			backupper.On("FinalizeBackup", mock.Anything, mock.Anything, mock.Anything, framework.BackupItemActionResolverV2{}, mock.Anything).Return(nil)
