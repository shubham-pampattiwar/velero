...
// PutBackupContentsFinalUpdates provides a mock function with given fields: backup, finalUpdates
func (_m *BackupStore) PutBackupContentsFinalUpdates(backup string, finalUpdates io.Reader) error {
	ret := _m.Called(backup, finalUpdates)

	var r0 error
	if rf, ok := ret.Get(0).(func(string, io.Reader) error); ok {
		r0 = rf(backup, finalUpdates)
	} else {
		r0 = ret.Error(0)
	}
