...
func (b *fakeBackupper) FinalizeBackup(logger logrus.FieldLogger, backup *pkgbackup.Request, backupFile io.Writer,
	backupItemActionResolver framework.BackupItemActionResolverV2,
	asyncBIAOperations []*itemoperation.BackupOperation) error {
	args := b.Called(logger, backup, backupFile, backupItemActionResolver, asyncBIAOperations)
	return args.Error(0)
}
