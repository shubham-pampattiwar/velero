...
func TestRestartableBackupItemActionDelegatedFunctions(t *testing.T) {
	...
	restartabletest.RunRestartableDelegateTests(
		...
		restartabletest.RestartableDelegateTest{
			...
			ExpectedErrorOutputs:    []interface{}{nil, ([]velero.ResourceIdentifier)(nil), "", false, errors.Errorf("reset error")},
			ExpectedDelegateOutputs: []interface{}{pvToReturn, additionalItems, "", false, errors.Errorf("delegate error")},
		},
		restartabletest.RestartableDelegateTest{
			Function:                "Progress",
