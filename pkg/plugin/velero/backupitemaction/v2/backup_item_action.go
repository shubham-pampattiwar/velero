...
type BackupItemAction interface {
	...
	// so a plugin should not return an OperationID if the backup phase is "FinalizingAfterPluginOperations"
	// or "FinalizingAfterPluginOperationsPartiallyFailed". The plugin should check the incoming
